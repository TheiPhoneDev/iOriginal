//
//  iPadWallpapersGalleryView.swift
//  iOriginal
//
...
struct iPadWallpapersGalleryView: View {
    
    var wallpapers: [iPadWallapapersDeviceDataModel] = []
        ...
        ScrollView(.vertical, showsIndicators: true, content: {
            LazyVGrid(columns: columns, content: {
                ForEach(wallpapers) { wallpaper in
                    if wallpaper.platform == ipadModelName {
                        NavigationLink {
...
#Preview {
    iPadWallpapersGalleryView(wallpapers: iPadCollection, ipadModelName: String())
}
