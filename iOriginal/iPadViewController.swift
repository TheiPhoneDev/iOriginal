...
struct iPadViewController: View {
            ...
            VStack {
                List(viewContents) { item in
                    NavigationLink(destination: item.attachedView, label: {
                        if(item.osName == "iOS 7"||item.osName == "iOS 8"||item.osName == "iOS 9"||item.osName == "iOS 12"||item.osName == "iPadOS 13"||item.osName == "iPadOS 14"||item.osName == "iPadOS 15") {
                            HStack {
                               Image(item.osImage)
                                   .resizable()
                                   .scaledToFit()
